...
class UserPolicy(BasePolicy):
    def __init__(self, env_id: str, observation_space: spaces.Space, action_space: spaces.Space):
        ...
        #rigid
        # cfg = Config.fromfile("./configs/mfrl/ppo/maniskill2_pn.py")  # Change this
        # model_path = f'./Model/PickSingleEGAD-v0/modify/model_20000.ckpt'  # Change this
        #soft
        cfg = Config.fromfile("./configs/brl/bc/pointnet_soft_body.py")  # Change this
        model_path = f'./Model/Fill/model_final.ckpt'  # Change this
        self.device = 'cuda:0'
    ...
    def get_control_mode(cls, env_id: str) -> str:
        ...
        # return "base_pd_joint_vel_arm_pd_joint_delta_pos"
        # return "base_pd_joint_vel_arm_pd_joint_vel"
        # return "base_pd_joint_vel_arm_pd_ee_delta_pose"
